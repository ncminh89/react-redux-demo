...
export class PhasesService {
    ...
    "tasks": [
      {
        ...
        "description": "Please post any questions you have in the comments on this task",
      ...
      },
      {
        ...
        "description": "Answer all remaining questions on production functionality and value",
  ...
  getOne(id: string) {
    var found = this.phases.find(e => e.id == id)
    if (!found) {
